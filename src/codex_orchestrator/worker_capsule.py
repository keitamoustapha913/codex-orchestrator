...
def report_schema_contract_text(*, patchlet_id: str, report_path: str, patchlet: dict | None = None) -> str:
    ...
    return (
        ...
        "Do not claim future slices or final master-prompt satisfaction.\n"
        "The orchestrator will preserve the raw worker claim and canonicalize proof only after independent probe rerun.\n\n"
